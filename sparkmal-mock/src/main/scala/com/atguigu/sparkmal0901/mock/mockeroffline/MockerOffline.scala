package com.atguigu.sparkmal0901.mock.mockeroffline

import java.text.SimpleDateFormat
import java.util.UUID

import com.atguigu.sparkmal0901.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.sparkmal0901.mock.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
...
object MockerOffline {
    ...
    def insertHive(sparkSession: SparkSession, tableName: String, dataFrame: DataFrame): Unit = {
        sparkSession.sql("use sparkmal0901")
